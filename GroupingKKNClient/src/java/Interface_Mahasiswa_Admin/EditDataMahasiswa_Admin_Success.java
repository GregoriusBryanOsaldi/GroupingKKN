 ...
 * @author greg
 */
@WebServlet(name = "EditDataMahasiswa_Admin_Success", urlPatterns = {"/EditDataMahasiswa_Admin_Success"})
public class EditDataMahasiswa_Admin_Success extends HttpServlet {
