            ...
            if (usernameTemp.equals("P.")) {
                ...
                try (PrintWriter out = response.getWriter()) {
                    ...
                    out.println("<tr>\n"
                            + "                            <td>Total SKS</td>\n"
                            + "                            <td>\n"
                            + "                                <input class=\"border rounded-0\" min =\"0\" type=\"number\" name=\"totalSks\" style=\"width: 70px;\" required=\"\" value=\""
                    ...
                    out.println("<tr>\n"
                            + "                            <td>Tinggi Badan</td>\n"
                            + "                            <td>\n"
                            + "                                <input class=\"border rounded-0\" min =\"0\" type=\"number\" name=\"tinggiBadan\" style=\"width: 70px;\" required=\"\" value=\""
                    ...
                    out.println("<tr>\n"
                            + "                            <td>Berat Badan</td>\n"
                            + "                            <td>\n"
                            + "                                <input class=\"border rounded-0\" min =\"0\" type=\"number\" name=\"beratBadan\" style=\"width: 70px;\" required=\"\" value=\""
                    ...
                    out.println("<tr>\n"
                            + "                            <td>Nomor HP</td>\n"
                            + "                            <td>\n"
                            + "                                <input class=\"border rounded-0\" min =\"0\" name=\"noHP\" type=\"number\" style=\"width: 300px;\" required=\"\" value=\""
                            + mahasiswa.getNoHP() + "\">\n"
                            + "                            </td>\n"
                            + "                        </tr>");
                    out.println("<tr>\n"
