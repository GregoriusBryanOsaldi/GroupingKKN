    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr>\n"
                    ...
                    + "                            <td>\n"
                    + "                                <input readonly=\"readonly\" class=\"border rounded-0\" type=\"text\" style=\"width: 300px;\" name=\"nim\" required=\"\" value=\""
                    + mahasiswa.getNim() + "\">\n"
                    + "                            </td>\n"
                    + "                        </tr>");
            out.println("<tr>\n"
            ...
            out.println("<tr>\n"
                    + "                            <td>Total SKS</td>\n"
                    + "                            <td>\n"
                    + "                                <input class=\"border rounded-0\" type=\"text\" name=\"totalSks\" style=\"width: 70px;\" required=\"\" value=\""
            ...
            out.println("<tr>\n"
                    + "                            <td>Tinggi Badan</td>\n"
                    + "                            <td>\n"
                    + "                                <input class=\"border rounded-0\" type=\"text\" name=\"tinggiBadan\" style=\"width: 70px;\" required=\"\" value=\""
            ...
            out.println("<tr>\n"
                    + "                            <td>Berat Badan</td>\n"
                    + "                            <td>\n"
                    + "                                <input class=\"border rounded-0\" type=\"text\" name=\"beratBadan\" style=\"width: 70px;\" required=\"\" value=\""
            ...
            out.println("<tr>\n"
                    + "                            <td>Nomor HP</td>\n"
                    + "                            <td>\n"
                    + "                                <input class=\"border rounded-0\" name=\"noHP\" type=\"text\" style=\"width: 300px;\" required=\"\" value=\""
                    + mahasiswa.getNoHP() + "\">\n"
                    + "                            </td>\n"
                    + "                        </tr>");
            out.println("<tr>\n"
                    + "                                <td>ID Kelompok</td>\n"
                    + "                                <td>\n"
                    + "                                    <input class=\"border rounded-0\" name=\"idKelompok\" type=\"text\" style=\"width: 70px;\" value=\""
