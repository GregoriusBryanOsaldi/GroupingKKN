 ...
 * @author greg
 */
@WebServlet(name = "DeleteDataMahasiswa_Admin_Success", urlPatterns = {"/DeleteDataMahasiswa_Admin_Success"})
public class DeleteDataMahasiswa_Admin_Success extends HttpServlet {
        ...
        if (usernameTemp.equals("P.")) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>\n"
                        ...
                        + "    </head>\n"
                        + "    <body>\n"
                        + "            <div class=\"alert alert-warning beautiful\" role=\"alert\"><strong>Success!</strong> please take a look at our update policy.</div>\n"
                        ...
                        + "            <a class=\"text-center\" href=\"./Logout\" style=\"margin-left: 1503px;padding: 0px;padding-top: 0px;padding-right: 0px;margin-top: 0px;\">Logout</a>\n"
                        + "        <div>\n"
                        + "            <h1 class=\"text-center\" style=\"margin-top: 20px;padding-right: 0px;font-size: 20px;margin-bottom: 0px;padding-left: 215px;\">DELETE DATA MAHASISWA</h1>\n"
                ...
                for (int i = 0; i < listMahasiswa.size(); i++) {
                    ...
                    out.println("\"" + listMahasiswa.get(i).getNim() + "\"data-toggle=\"modal\" data-target=\"#myModal" + i + "\">Delete</button></td>");
                    out.println("</tr>");
                    out.println("<div id=\"myModal" + i + "\" class=\"modal fade\">\n"
                            + "        <div class=\"modal-dialog modal-confirm\">\n"
                            + "            <div class=\"modal-content\">\n"
                            + "                <div class=\"modal-header\">\n"
                            + "                    <h4 class=\"modal-title\">Are you sure delete");
                    out.println(listMahasiswa.get(i).getNama() + "(" + listMahasiswa.get(i).getNim() + ")?</h4>	\n"
                            ...
                            + "<form action=\"./DeleteDataMahasiswa\" method=\"post\">\n"
                            + "                    <button type=\"button\" class=\"btn btn-info\" data-dismiss=\"modal\">Cancel</button>\n");
                    out.println("                  <button name=\"delete\" value=");
                    out.println("\"" + listMahasiswa.get(i).getNim() + "\" type=\"submit\" class=\"btn btn-danger\">Delete</button>\n");
                    out.println("</form>\n"
                            + "                </div>\n"
                            + "             </div>\n"
                            + "       </div>\n"
