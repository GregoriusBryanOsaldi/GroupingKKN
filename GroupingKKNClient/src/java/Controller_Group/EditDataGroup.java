 ...
 * @author greg
 */
@WebServlet(name = "EditDataGroup", urlPatterns = {"/EditDataGroup"})
public class EditDataGroup extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        editDataGroup(kelompok);
        response.sendRedirect("./EditDataGroup_Admin_Success");
    }
