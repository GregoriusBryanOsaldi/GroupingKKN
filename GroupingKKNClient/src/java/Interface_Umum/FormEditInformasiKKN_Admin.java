 ...
 * @author greg
 */
@WebServlet(name = "FormEditInformasiKKN_Admin", urlPatterns = {"/FormEditInformasiKKN_Admin"})
public class FormEditInformasiKKN_Admin extends HttpServlet {
        ...
        if (usernameTemp.equals("P.")) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<div>\n"
                        ...
                        + "        <form action=\"./UpdateInformasiKKN\" method=\"post\">"
                        + "            <label style=\"margin-left: 400px;margin-top: 30px; margin-bottom: 5px;\"><b>Type below:</b></label>");
                out.println("<textarea  name=\"informasi\" rows=\"10\" cols=\"50\"style=\"resize: none;margin-left: 400px;width: 1000px; height: 200px\">" + informasi + "</textarea>");
                out.println("<button class=\"btn btn-primary\" type=\"submit\" style=\"margin-left: 400px;margin-bottom: 30px;margin-top: 10px;width: 95px;height: 40;\">Submit</button>\n"
                        + "        </form>\n"
                        + "        </div>\n"
