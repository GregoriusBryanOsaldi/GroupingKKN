 ...
 * @author greg
 */
@WebServlet(name = "EditDataGroup_Admin_Success", urlPatterns = {"/EditDataGroup_Admin_Success"})
public class EditDataGroup_Admin_Success extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>\n"
                    ...
                    + "        </div>\n"
                    + "        <div>\n"
                    + "            <h1 class=\"text-center\" style=\"margin-top: 20px;padding-right: 0px;font-size: 20px;margin-bottom: 0px;padding-left: 215px;\">EDIT DATA GROUP</h1>\n"
            ...
            for (int i = 0; i < listKelompok.size(); i++) {
                ...
                out.println("\"" + listKelompok.get(i).getIdKelompok() + "\"data-toggle=\"modal\" data-target=\"#myModal" + i + "\">Edit</button></td>");
                out.println("</tr>");
                out.println("<div id=\"myModal" + i + "\" class=\"modal fade\">\n"
                        + "        <div class=\"modal-dialog modal-confirm\">\n"
                        + "            <div class=\"modal-content\">\n"
                        + "                <div class=\"modal-header\">\n"
                        + "                    <h4 class=\"modal-title\">Are you sure edit kelompok ");
                out.println(listKelompok.get(i).getIdKelompok() + "?</h4>	\n"
                        ...
                        + "<form action=\"./FormEditDataGroup_Admin\" method=\"post\">\n"
                        + "                    <button type=\"button\" class=\"btn btn-info\" data-dismiss=\"modal\">Cancel</button>\n");
                out.println("                  <button name=\"edit\" value=");
                out.println("\"" + listKelompok.get(i).getIdKelompok() + "\" type=\"submit\" class=\"btn btn-danger\">Edit</button>\n");
                out.println("</form>\n"
                        + "                </div>\n"
                        + "             </div>\n"
                        + "       </div>\n"
