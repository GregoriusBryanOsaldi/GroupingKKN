 ...
 * @author greg
 */
@WebServlet(name = "UpdateInformasiKKN", urlPatterns = {"/UpdateInformasiKKN"})
public class UpdateInformasiKKN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("./HalamanUtama_Admin_Success");
    }
