 ...
 * @author greg
 */
@WebServlet(name = "CreateGroupKKN", urlPatterns = {"/CreateGroupKKN"})
public class CreateGroupKKN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        createGroupKKN(listMahasiswa);
        response.sendRedirect("./CreateGroupKKN_Admin_Success");
    }
