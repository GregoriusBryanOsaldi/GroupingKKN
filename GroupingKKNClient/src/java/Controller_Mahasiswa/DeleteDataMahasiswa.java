 ...
 * @author greg
 */
@WebServlet(name = "DeleteDataMahasiswa", urlPatterns = {"/DeleteDataMahasiswa"})
public class DeleteDataMahasiswa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        deleteDataMahasiswa(key);
        response.sendRedirect("./DeleteDataMahasiswa_Admin_Success");
    }
